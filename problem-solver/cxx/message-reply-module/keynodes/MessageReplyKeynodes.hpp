...
public:
  ...
  static inline ScKeynode const nrel_reply{"nrel_reply", ScType::ConstNodeNoRole};
  ...
  static inline ScKeynode const nrel_message_sequence{"nrel_message_sequence", ScType::ConstNodeNoRole};
